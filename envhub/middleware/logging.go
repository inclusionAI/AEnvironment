...
func InitLogger() *zap.Logger {
	...
	logWriter := zapcore.AddSync(&lumberjack.Logger{
		Filename:   "/home/admin/logs/aenvhub-backend.log", // Log file path
		MaxSize:    100,                                    // Maximum size of each log file (MB)
		MaxBackups: 30,                                     // Maximum number of old files to retain
		MaxAge:     0,                                      // Maximum number of days to retain old files (0 means forever)
...
// ResponseWriter is a custom ResponseWriter used to capture response body
...
func LoggingMiddleware(logger *zap.Logger) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Filter health check paths, do not log
		...
		if c.Request.Body != nil {
			...
			// Restore Body, as ReadAll consumes it
