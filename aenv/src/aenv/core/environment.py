...
class Environment:
    ...
    def __init__(
        ...
        Args:
            ...
            skip__for_healthy: Skip health check if True (defaults to False)
        """
        ...
        self.skip__for_healthy = skip__for_healthy
